            ...
            <div className="flex justify-around items-center flex-col-reverse gap-10 md:flex-row">
              <div className="h-auto w-2/3 xl:w-1/2 bg-[#EFE2F0]/50 rounded-3xl flex flex-col items-center justify-around p-10">
                ...
                <div className="pt-5">
                  ...
                  >
                    <option value="option1">Mindfulness</option>
                    <option value="option2">Meditation</option>
                    <option value="option3">CBT</option>
                    <option value="option4">Breathwork</option>
                    <option value="option5">Yoga</option>
                    <option value="option6">Motivational</option>
                    <option value="option7">Holistic</option>
                    <option value="option7">More</option>
                  </select>
                </div>
