...
const Progress = () => {
    ...
    <div>
      {answeredQuestion1 ? (
        <div>
          ...
          <button className="boxbutton" onClick={handleQuestionAfterBox}>
            Box Breathing
          </button>
        </div>
      ) : (
  ...
  <img src={QAarray[currentQuestionIndex-1].answer} alt="" />
      ...
      currentQuestionIndex == 12 ? (
        <div>
          <button className="border border-red-200 w-5/6" onClick={handleYes}>
            Yes
          </button>
          <button className="border border-red-200 w-5/6" onClick={handleNo}>
            No
          </button>
        </div>
      ) : null}
      ...
      {currentQuestionIndex == 14 ? (
        <div>
          ...
          <button onClick={handleNest} className="border border-red-200 w-5/6">
            Return to my Nest
          </button>
        </div>
      ) : null}
